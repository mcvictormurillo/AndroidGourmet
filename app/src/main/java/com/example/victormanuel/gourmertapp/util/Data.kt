...
/**
 * Created by Victor Manuel on 12/12/2017.
 */
...
object Data {
    ...
    var menus: MutableList<Menu> = mutableListOf(
            Menu("Parrilla", "210 min", "30 de Mayo",
                    "http://bgcofmarion.com/wp-content/uploads/2015/05/iStock_000024874099_Small.jpg",
            ...
            Menu("Bisteck", "220 min", "18 de Mayo",
                    "http://solviptravel.com/wp-content/uploads/2016/06/La-Parrilla-La-original.jpg",
            ...
            Menu("Pescados y Mariscos", "190 min", "08 de Junio",
                    "https://pbs.twimg.com/media/CegjR-aUMAARs88.jpg:large",
